...
export function Landing() {
  ...
  // Parallax & Scroll Effects - Reduce on mobile for performance
  const y1 = useTransform(scrollYProgress, [0, 1], [0, isMobile ? -50 : -200]);
      ...
      <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 selection:text-primary font-sans overflow-x-hidden transition-colors duration-500">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none">
          ...
          <motion.div
            ...
            style={{ y: y1 }}
            className={cn(
              "absolute top-[-10%] right-[-10%] w-[70%] h-[70%] bg-primary/10 dark:bg-primary/25 rounded-full",
              isMobile ? "blur-[80px]" : "blur-[140px]"
            )}
          />
          <motion.div
            ...
            style={{ y: y2 }}
            className={cn(
              "absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-blue-500/5 dark:bg-orange-900/10 rounded-full",
              isMobile ? "blur-[100px]" : "blur-[160px]"
            )}
          />
        ...
        <nav className="fixed top-0 left-0 right-0 z-[100] px-4 py-4 md:px-6 md:py-6">
          <motion.div
            ...
            className="max-w-7xl mx-auto flex justify-between items-center px-4 py-2 md:px-6 md:py-3 bg-card/60 backdrop-blur-xl md:backdrop-blur-2xl border border-border shadow-2xl rounded-[1.5rem] md:rounded-[2rem]"
          >
            <div className="flex items-center gap-2 group cursor-pointer" onClick={() => navigate("/")}>
              <div className="w-8 h-8 md:w-10 md:h-10 bg-primary rounded-xl md:rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform shadow-lg shadow-primary/40">
            ...
            <div className="flex items-center gap-2 md:gap-4">
               ...
               <Button className="bg-primary text-white hover:bg-primary/90 rounded-xl font-bold px-4 md:px-6 h-9 md:h-11 shadow-xl shadow-primary/20 transition-all border-none text-xs md:text-sm" onClick={() => navigate("/signup/tenant")}>
                Get Started
               </Button>
            </div>
          </motion.div>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 md:pt-32 pb-16 md:pb-20 px-4 md:px-6 z-10 overflow-hidden">
          ...
          >
            <motion.div
                variants={fadeIn}
                className="inline-flex items-center gap-2 px-4 py-1.5 md:px-5 md:py-2 rounded-full bg-primary/10 border border-primary/20 shadow-sm mb-8 md:mb-10 backdrop-blur-md"
            >
            ...
            <motion.h1
                variants={fadeIn}
                className="text-5xl sm:text-7xl md:text-8xl lg:text-[9rem] font-black tracking-tighter mb-8 md:mb-10 leading-[0.9] md:leading-[0.85] text-foreground"
            >
              Live where you <br />
            ...
            <motion.p
                variants={fadeIn}
                className="text-lg md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-12 md:mb-16 font-medium leading-relaxed px-4 md:px-0"
            >
            ...
            <motion.div
                variants={fadeIn}
                className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-20 md:mb-32 w-full max-w-md mx-auto sm:max-w-none px-6 md:px-0"
            >
              <MagneticButton className="w-full sm:w-auto">
                <Button
                    size="lg"
                    className="w-full sm:w-auto px-8 md:px-12 py-6 md:py-8 text-lg md:text-xl font-black rounded-2xl bg-primary text-white shadow-[0_15px_60px_rgba(232,85,61,0.4)] md:shadow-[0_20px_100px_rgba(232,85,61,0.5)] hover:scale-105 transition-all group border-none"
                    onClick={() => navigate("/signup/tenant")}
                >
                  START MATCHING <ArrowRight className="ml-3 w-5 h-5 md:w-6 md:h-6 group-hover:translate-x-2 transition-transform" />
                </Button>
              </MagneticButton>
              ...
              <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto px-8 md:px-12 py-6 md:py-8 text-lg md:text-xl font-bold rounded-2xl bg-card/50 border-primary/20 text-foreground hover:bg-primary/10 hover:border-primary/40 transition-all shadow-lg backdrop-blur-xl"
        ...
        <section id="vibe" className="relative py-20 md:py-40 px-4 md:px-6 z-10 bg-card/20 backdrop-blur-sm border-y border-border/50">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}>
                ...
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter mb-8 md:mb-10 leading-[0.95] md:leading-[0.9] text-foreground">
                   Dynamic <br /><span className="text-primary italic">Vibe-Scoring.</span>
                </h2>
                <p className="text-muted-foreground text-lg md:text-2xl mb-10 md:mb-12 font-medium leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  {[
                    ...
                    <motion.div key={i} whileHover={isMobile ? {} : { y: -5 }} className="p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-card border border-border shadow-sm hover:shadow-xl transition-all">
              ...
              <div className="relative mt-12 lg:mt-0">
                 <div className="absolute -inset-10 bg-primary/10 blur-[80px] md:blur-[100px] rounded-full" />
                 <Card className="relative border border-border shadow-2xl rounded-[2.5rem] md:rounded-[3rem] overflow-hidden bg-card/50 backdrop-blur-2xl">
                    <CardContent className="p-8 md:p-12">
                       ...
                       <div className="space-y-8 md:space-y-10">
                          {[
                            ...
                            <div key={i} className="space-y-3">
                               ...
                               <div className="h-2.5 md:h-3 bg-foreground/5 dark:bg-white/5 rounded-full overflow-hidden">
                                  <motion.div
                                    initial={{ width: 0 }}
                       ...
                       <div className="mt-12 md:mt-16 p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-primary/5 dark:bg-primary/10 border border-primary/20 text-foreground text-center">
        ...
        <section id="maps" className="relative py-20 md:py-40 px-4 md:px-6 z-10 overflow-hidden bg-card/10 dark:bg-[#0a0a0a]">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <div className="relative order-2 lg:order-1 mt-12 lg:mt-0">
                 <div className="absolute -inset-10 bg-primary/10 blur-[100px] md:blur-[120px] rounded-full" />
                 <div className="relative aspect-square bg-card/50 border border-border rounded-[2.5rem] md:rounded-[3rem] p-3 md:p-4 backdrop-blur-md overflow-hidden shadow-2xl">
                    <div className="w-full h-full rounded-[2rem] bg-muted relative overflow-hidden">
                       ...
                       <motion.div
                         ...
                         className="absolute top-[25%] left-[25%] -translate-x-1/2 -translate-y-1/2 text-white bg-primary p-2 md:p-3 rounded-full shadow-[0_0_20px_rgba(232,85,61,0.6)] md:shadow-[0_0_30px_rgba(232,85,61,0.6)] border-2 border-white/30 z-20"
                       >
                         <Home className="w-4 h-4 md:w-6 md:h-6" />
                         <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-primary text-[8px] md:text-[10px] font-black px-2 py-0.5 md:py-1 rounded-md whitespace-nowrap shadow-2xl border border-white/10 uppercase">Initial Location</div>
                       </motion.div>

                       <motion.div
                         animate={{ y: [0, -6, 0], scale: [1, 1.05, 1] }}
                         transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}
                         className="absolute top-[75%] left-[75%] -translate-x-1/2 -translate-y-1/2 text-white bg-blue-600 p-2 md:p-3 rounded-full shadow-[0_0_20px_rgba(37,99,235,0.6)] md:shadow-[0_0_30px_rgba(37,99,235,0.6)] border-2 border-white/30 z-20"
                       >
                         <GraduationCap className="w-4 h-4 md:w-6 md:h-6" />
                         <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-blue-600 text-[8px] md:text-[10px] font-black px-2 py-0.5 md:py-1 rounded-md whitespace-nowrap shadow-2xl border border-white/10 uppercase">Monash Campus</div>
                       </motion.div>
                       ...
                       <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6 bg-black/95 backdrop-blur-2xl border border-white/10 p-4 md:p-5 rounded-xl md:rounded-2xl shadow-2xl z-30">
                          <div className="flex justify-between items-center text-white">
                             ...
                             <div className="flex flex-col items-end">
                                <div className="bg-primary/20 text-primary px-2 py-0.5 md:px-3 md:py-1 rounded-md md:rounded-lg text-[8px] md:text-[10px] font-black border border-primary/20 mb-1 uppercase">Matched</div>
                ...
                <div className="space-y-4 md:space-y-6">
                   {[
                     ...
                     <div key={i} className="flex items-center gap-3 md:gap-4 text-foreground">
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-card border border-border flex items-center justify-center shadow-lg shadow-primary/5">
        ...
        <section id="interest" className="relative py-20 md:py-40 px-4 md:px-6 z-10 bg-background transition-colors duration-500">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 md:mb-24">
               <h2 className="text-4xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-6 md:mb-8 leading-[0.95] md:leading-none text-foreground">Express <span className="text-primary italic underline decoration-primary/10 underline-offset-[8px] md:underline-offset-[12px]">Interest.</span></h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
              <div className="relative flex justify-center lg:justify-start">
                <motion.div
                    ...
                    dragSnapToOrigin
                    className="relative w-full max-w-[320px] md:max-w-[420px] aspect-[3/4.5] bg-card rounded-[2.5rem] md:rounded-[3rem] shadow-2xl border border-border overflow-hidden cursor-grab active:cursor-grabbing group"
                >
                  <motion.div style={{ opacity: likeOpacity }} className="absolute top-8 md:top-12 right-6 md:right-10 z-[60] border-2 md:border-4 border-primary text-primary font-black text-2xl md:text-4xl px-3 md:px-4 py-0.5 md:py-1 rotate-[15deg] rounded-lg md:rounded-xl bg-background/80 backdrop-blur-md uppercase">Interested</motion.div>
                  <motion.div style={{ opacity: nopeOpacity }} className="absolute top-8 md:top-12 left-6 md:left-10 z-[60] border-2 md:border-4 border-foreground/40 text-foreground/40 font-black text-2xl md:text-4xl px-3 md:px-4 py-0.5 md:py-1 rotate-[-15deg] rounded-lg md:rounded-xl bg-background/80 backdrop-blur-md uppercase">Pass</motion.div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 z-20">
                    <div className="bg-black/60 backdrop-blur-3xl p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-white/10 shadow-2xl">
                        <div className="flex justify-between items-start mb-3 md:mb-4">
                            <h4 className="text-xl md:text-3xl font-black tracking-tighter text-white">Modern Loft</h4>
                            <div className="bg-primary text-white px-2.5 py-0.5 md:px-3 md:py-1 rounded-full text-[8px] md:text-[10px] font-black uppercase">98% Fit</div>
                        </div>
                        <div className="flex items-center gap-2 text-white/40 text-[10px] md:text-xs font-bold uppercase tracking-widest border-t border-white/10 pt-3 md:pt-4">
              ...
              <div className="space-y-8 md:space-y-12">
                 {[
                   ...
                   <motion.div key={i} whileHover={isMobile ? {} : { x: 10 }} className="flex gap-5 md:gap-6 group">
                      <div className="w-12 h-12 md:w-16 md:h-16 shrink-0 rounded-xl md:rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20 group-hover:bg-primary/20 transition-all">
                         <Star className="w-6 h-6 md:w-8 md:h-8 text-primary" />
                      </div>
                      <div>
                         <h3 className="text-xl md:text-2xl font-black tracking-tight mb-1 md:mb-2 uppercase text-foreground">{item.title}</h3>
                         <p className="text-muted-foreground text-base md:text-lg leading-relaxed font-medium">{item.desc}</p>
                      </div>
                   </motion.div>
                 ))}
              </div>
        ...
        {/* 5. FOOTER / FINAL CTA */}
        <footer className="relative py-32 md:py-60 text-center border-t border-border bg-card/10 z-10 overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_100%,rgba(232,85,61,0.15),transparent_60%)]" />

          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative z-10 max-w-5xl mx-auto px-4 md:px-6">
            <h2 className="text-5xl sm:text-7xl md:text-9xl lg:text-[11rem] font-black mb-12 md:mb-16 tracking-tighter text-foreground leading-[0.9] md:leading-[0.85]">
            ...
            <MagneticButton className="inline-block w-full sm:w-auto">
                <Button
                    size="lg"
                    className="w-full sm:w-auto px-10 md:px-16 py-8 md:py-12 text-xl md:text-3xl font-black rounded-[1.5rem] md:rounded-[2.5rem] bg-primary text-white shadow-[0_20px_80px_rgba(232,85,61,0.4)] md:shadow-[0_30px_100px_rgba(232,85,61,0.5)] hover:scale-110 transition-all hover:bg-foreground dark:hover:bg-white hover:text-background dark:hover:text-black border-none"
                    onClick={() => navigate("/signup/tenant")}
                >
                    START MATCHING
                </Button>
            ...
            <div className="mt-24 md:mt-48 text-muted-foreground/30 text-[9px] md:text-[12px] font-black uppercase tracking-[0.4em] md:tracking-[0.6em] px-4">
