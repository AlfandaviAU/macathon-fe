...
import { Home, Eye, EyeOff, Loader2, ArrowLeft, ArrowRight, Building2, User, Mail, Phone, Lock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-background text-foreground overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none opacity-40">
        ...
        <div className="absolute top-[-10%] left-[-20%] w-[60%] h-[60%] bg-[#e8553d]/10 rounded-full blur-[140px]" />
      ...
      <div className="w-full max-w-xl relative z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-lg font-medium max-w-md mx-auto">List your property and find high-compatibility tenant tribes automatically.</p>
        </div>
